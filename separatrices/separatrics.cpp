...
void find_singularity(icMatrix2x2 tensor[4], double o[2])
{
    ...
    double x1 =
    -((T012*T211-2*T112*T211-T011*T212+T022*T212+2*T111*T212-2*T122*T212-T012*T222+2*
    T112*T222+T112*T311-T111*T312+T122*T312-T112*T322+
    sqrt(pow((-T011*T212+T022*T212+T012*(T211-T222)+(T111-T122)*(2*T212-T312)+T112*
    (-2*T211+2*T222+T311-T322)),2)-4*((-T111+T122)*T212+T112*(T211-T222))*
    ((T011-T022-T111+ T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322))))
      /(2*((T011-T022-T111+T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322))));
    
    double y1 =(-T012*T211+T011*T212-T022*T212+T012*T222+T112*T311-2*T212*T311-T111*
    T312+T122*T312+2*T211*T312-2*T222*T312-T112*T322+2*T212*T322+
    sqrt(pow((-T011*T212+T022*T212+T012*(T211-T222)+(T111-T122)*(2*T212-T312)+T112*
    (-2*T211+2*T222+T311-T322)),2)-4*((-T111+T122)*T212+T112*(T211-T222))*
    ((T011-T022-T111+T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322))))
    ...
    2*T112*T222-T112*T311+T111*T312-T122*T312+T112*T322+
    sqrt(pow((-T011*T212+T022*T212+T012*(T211-T222)+(T111-T122)*(2*T212-T312)+T112*
    (-2*T211+2*T222+T311-T322)),2)-4*((-T111+T122)*T212+T112*(T211-T222))*
    ((T011-T022-T111+T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322))))
    /(2*((T011-T022-T111+T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322)));
    ...
    double y2 =
    -((T012*T211-T011*T212+T022*T212-T012*T222-T112*T311+2*T212*T311+T111*T312-T122*
    T312-2*T211*T312+2*T222*T312+T112*T322-2*T212*T322+
    sqrt(pow((-T011*T212+T022*T212+T012*(T211-T222)+(T111-T122)*(2*T212-T312)+T112*
    (-2*T211+2*T222+T311-T322)),2)-4*((-T111+T122)*T212+T112*(T211-T222))*
    ((T011-T022-T111+T122)*(T212-T312)-(T012-T112)*(T211-T222-T311+T322))))
    /(2*((T111-T122-T211+T222)*(T012-T312)-(T112-T212)*(T011-T022-T311+T322))));
   	
   	//when singularity is zero above formulas divide by zero 
   	if(isnan(x1) || isnan(x2)){
   		o[0] = 0;
        o[1] = 0;
        return;
   	}
    //use the singularity in range (0,1)
